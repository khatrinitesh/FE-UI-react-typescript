...
const FieldInputComponent: React.FC<InputProps> = ({
  type = "text",
  placeholder = "",
  maxLength,
  id,
  ...
  const baseStyle =
    "px-4 py-2 w-full rounded-0 text-[1rem] md:text-[1.125rem] h-[48px] fontpoppinsr outline-none transition duration-200";
